...
public class SellerCateController extends BaseController {
    ...
    public String getShopCateList(HttpServletRequest request, HttpServletResponse response,
                                  Map<String, Object> dataMap, int sellerId) {
    ...
    public String productList(@PathVariable String visitPath, HttpServletRequest request,
        ...
        return "h5/seller/sellerproductlist";
    }
