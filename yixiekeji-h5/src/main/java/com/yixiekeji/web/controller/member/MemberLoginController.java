...
//    }
    ...
    public String memberAccount(HttpServletRequest request, HttpServletResponse response,
                                Map<String, Object> dataMap) {
        Member sessionMember = WebFrontSession.getLoginedUser(request);
        Integer memberId = sessionMember.getId();
        // 获取member对象
     ...
     * @Date: 2019/10/9
     */
    @GetMapping(value = "/checkMobileByForgetPassWord")
    @ResponseBody
     ...
     * @Date: 2019/10/12
     */
    @GetMapping(value = "/getMemberData")
    @ResponseBody
