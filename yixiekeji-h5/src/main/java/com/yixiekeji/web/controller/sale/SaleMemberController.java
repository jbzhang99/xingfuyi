...
public class SaleMemberController extends BaseController {
    ...
    public String saleFinanceInfo(HttpServletRequest request, HttpServletResponse response,
        ...
        return "h5/member/sale/salefinance";
    }
    ...
    public String saleMember1(HttpServletRequest request, HttpServletResponse response,
        ...
        return "h5/member/sale/salemember1";
    }
    ...
    public String saleMember2(HttpServletRequest request, HttpServletResponse response,
        ...
        return "h5/member/sale/salemember2";
    }
    ...
    public ServiceResult saleFinance(HttpServletRequest request, HttpServletResponse response,
        ...
        Object reg_smsCode = session.getAttribute("_smsCode");
     ...
     * @Date: 2019/10/19
     */
    @PostMapping(value = "/guardianAuth")
    @ResponseBody
     ...
     * @Date: 2019/10/19
     */
    @PostMapping(value = "/disabilityAuth")
    @ResponseBody
