...
public class OrdersController extends BaseController {
    ...
    public String toOrderSubmit(HttpServletRequest request, ModelMap map,
        ...
        if (memberAddress != null) {
            cartServiceResult = cartService.getCartInfoByMId(member.getId(), memberAddress,
                ConstantsEJS.SOURCE_2_H5, 2);
        } else {
            cartServiceResult = cartService.getCartByMId(member.getId(), ConstantsEJS.SOURCE_2_H5,
                    2);
        }
