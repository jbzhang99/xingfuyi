      	...
      	<#if seller?? >
            ...
            <div>
           	  <#if product?? && productGoods?? >
	              <a href="${(domainUrlUtil.urlResources)!}/tuan/${(actGroup.id)!0}.html" class="block">
	              <dl class="img-ul cart-ul flex">
	                <dt style="width:80px;height:80px;"><img src="${(domainUrlUtil.imageResources)!}${(actGroup.image)!''}"></dt>
