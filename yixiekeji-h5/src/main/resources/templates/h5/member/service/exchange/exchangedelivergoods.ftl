...
<body class="bgf2">
   ...
   <!-- 头部 end-->
   	<@form.form  id ="productBackForm" action="${(domainUrlUtil.urlResources)!}/member/doExchangeDeliverGoods.html">
	<!-- 隐藏域 -->
	<input type="hidden" id="id" name="id" value="${(memberProductExchange.id)!0}">
	<div class=""  >
					...
					<div class='starbox'>
					      ...
					      <div class='starlist flex pad10'>
							  ...
							  <div class='' style='margin-left:8px;'>
								  	<select  class="form-control cselct" id="logisticsId2" name="logisticsId2" style="width:16rem;"> 
					      ...
					      <div class='starlist flex pad10'>
							  ...
							  <div class='s-exchange' style='margin-left:8px;'>
							  		<input type="text" name="logisticsNumber2" id="logisticsNumber2" class="form-control" style="width:16rem;">
							  </div>
						</div>
...
<script type="text/javascript">
	...
	function applySubmit() {
		...
		var logisticsNumber2 = $("#logisticsNumber2").val();
		if (logisticsNumber2 == null || logisticsNumber2 == "") {
		...
		$.ajax({
			...
			success:function(data){
				if(data.success){
					...
					window.location.href= "${(domainUrlUtil.urlResources)!}/member/exchange.html";
				}else{
