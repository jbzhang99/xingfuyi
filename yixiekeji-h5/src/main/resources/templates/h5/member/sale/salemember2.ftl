...
<body class="bgf2">
	...
	<header id="header">
		<div class="flex flex-align-center head-bar">
			...
			<div class="flex-2 text-center">我的间接推广用户</div>
    ...
    <!-- 主体 start-->
        ...
        <div class="derailedCon">
            <form action="${(domainUrlUtil.urlResources)!}/member/sale-member2.html" method="get" class="mybalance-search">
              <div class="searchItm">
              ...
              <div class="searchItm">
                ...
                <input type="text" id="q_referrerName" name="q_referrerName" value="${q_referrerName!''}" class="search__odn" placeholder="请输入推荐人用户名">
              </div>
              <div class="btnaera">
			    ...
			    <#if saleMembers??>
					<#list saleMembers as saleMember>
				          <div class="item-lis">
				            ...
				            <div class="th-cell">
				              <label>推 荐 人：</label><span>${(saleMember.referrerName)!""}</span>
				            </div>
				            <div class="th-cell">
...
$(function(){
	...
	$("#saleapplymoney_more_json").click(function(){
		...
		var q_referrerName = $("#q_referrerName").val();
		
		var urljson = "${(domainUrlUtil.urlResources)!}/member/sale-member2-json.html?pageNum=" + list_page + "&q_referrerName=" + q_referrerName;
		alert(urljson);
		var listJsonHtml = "";
		$.ajax({
            type:"get",
            ...
            success:function(data){
                if (data.success) {
                    $.each(data.data, function(i, info){
        					...
        					listJsonHtml += "<div class='th-cell'><label>推 荐 人：</label><span>" + info.referrerName + "</span></div>";
