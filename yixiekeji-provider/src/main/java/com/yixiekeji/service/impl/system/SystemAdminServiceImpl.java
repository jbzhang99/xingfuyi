...
import com.yixiekeji.model.system.SystemAdminModel;
...
public class SystemAdminServiceImpl implements ISystemAdminService {
    ...
    @Override
    public ServiceResult<SystemAdmin> getSystemAdminById(@RequestParam("systemAdminId") Integer systemAdminId) {
    ...
    @Override
    public ServiceResult<Integer> saveSystemAdmin(@RequestBody SystemAdmin systemAdmin) {
        ...
        try {
            ...
            log.error("保存系统管理员表时出现异常：" + be.getMessage());
        } catch (Exception e) {
    ...
    @Override
    public ServiceResult<Integer> updateSystemAdmin(@RequestBody SystemAdmin systemAdmin) {
        ServiceResult<Integer> result = new ServiceResult<Integer>();
        try {
            ...
            result.setSuccess(false);
            result.setMessage(be.getMessage());
            log.error("更新系统管理员表时出现异常：" + be.getMessage());
        } catch (Exception e) {
    ...
    @Override
    public ServiceResult<List<SystemAdmin>> page(@RequestBody FeignUtil feignUtil) {
    ...
    @Override
    public ServiceResult<SystemAdmin> getSystemAdminByNamePwd(@RequestParam("name") String name,
    ...
    @Override
    public ServiceResult<List<SystemAdmin>> getSystemAdminByName(@RequestParam("name") String name) {
