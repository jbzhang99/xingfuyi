...
import com.yixiekeji.dao.shop.write.member.MemberApplyDrawingWriteDao;
...
public class MemberApplyDrawingModel {
    ...
    */
    public Integer updateMemberApplyDrawing(MemberApplyDrawing memberApplyDrawing) {
        ...
        try {
            //打款操作扣除余额
            if (ConstantsEJS.MEMBER_DRAWING_STATE_2 == memberApplyDrawing.getState().intValue()) {
     ...
     * @return
     */
    public Integer paid(Integer id, Integer optId, String optName) {
        return memberApplyDrawingWriteDao.paid(id, ConstantsEJS.MEMBER_DRAWING_STATE_3, optId,
            optName);
    }
