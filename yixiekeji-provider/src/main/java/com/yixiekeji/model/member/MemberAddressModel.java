...
import com.yixiekeji.dao.shop.read.member.MemberAddressReadDao;
...
import com.yixiekeji.dao.shop.write.member.MemberAddressWriteDao;
...
public class MemberAddressModel {
    ...
    public Integer saveAddress(MemberAddress memberAddress) {
        return  memberAddressWriteDao.saveAddress(memberAddress);
    }

    public MemberAddress getMaxId() {
        return memberAddressReadDao.getMaxId();
    }
}
