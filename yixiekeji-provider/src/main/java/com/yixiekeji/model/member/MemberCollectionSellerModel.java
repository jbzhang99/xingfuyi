...
import com.yixiekeji.dao.shop.write.member.MemberCollectionSellerWriteDao;
...
public class MemberCollectionSellerModel {
    ...
    */
    ...
    public Integer getCollectionSeller(Integer memberId) {
        Map<String, Object> queryMap = new HashMap<String, Object>();
        queryMap.put("memberId", memberId);
        queryMap.put("state", MemberCollectionSeller.STATE_1);
        return memberCollectionSellerReadDao.queryCount(queryMap);
    }
}
