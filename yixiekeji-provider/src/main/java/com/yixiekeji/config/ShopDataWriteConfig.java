...
@Configuration
@ConfigurationProperties(prefix = "shop.datasource.write")
@MapperScan(basePackages = ShopDataWriteConfig.PACKAGE, sqlSessionFactoryRef = "shopWriteSqlSessionFactory")
public class ShopDataWriteConfig {

    /**
     * dao层的包路径
     */
    static final String         PACKAGE         = "com.yixiekeji.dao.shop.write";

    /**
     * mapper文件的相对路径
     */
    private static final String MAPPER_LOCATION = "classpath:sql-mapper/shop/write/**/*.xml";
    ...
    public SqlSessionFactory shopWriteSqlSessionFactory(@Qualifier("shopWriteDataSource") DataSource shopWriteDataSource) throws Exception {
        ...
        sessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver()
            .getResources(ShopDataWriteConfig.MAPPER_LOCATION)); // 设置mapper文件路径
