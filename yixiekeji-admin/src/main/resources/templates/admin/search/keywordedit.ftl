...
$(function(){
	$("#back").click(function(){
	 		window.location.href="${domainUrlUtil.urlResources}/admin/searchkeyword";
		});
	$("#add").click(function(){
			if($("#addForm").form('validate')){
		 		$("#addForm").attr("action", "${domainUrlUtil.urlResources}/admin/searchkeyword/update")
	  				 .attr("method", "POST")
	  				 .submit();
	  		}
		});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">敏感词修改<span class="s-poar"><a class="a-back" href="${domainUrlUtil.urlResources}/admin/searchkeyword">返回</a></span></h2>
