...
<script type="text/javascript">
	...
	$(function(){
		addTab('首页', '${domainUrlUtil.urlResources}/admin/indexPage')
    ...
    <div data-options="region:'north',split:false" style=" background-color:#dfe8f7; padding:10px 0; height:50px;">
       <h2 style="font-size: 24px; font-family:'微软雅黑';text-indent:7px; margin:0px; letter-spacing:2px; font-weight:normal; line-height:22px;">幸福易运营管理平台</h2>
       <span style="float:right; height:16px; margin-top:-17px; margin-right:55px;">欢迎：${SESSION_ADMIN_USER.name}</span>
       <a href="${(domainUrlUtil.urlResources)!}/admin/exit" style="float:right; height:16px; margin-top:-17px; padding-right:22px;" title="退出系统"><img src="${(domainUrlUtil.staticResources)!}/resources/admin/images/log-out.png" border="0"/></a>
    </div>
