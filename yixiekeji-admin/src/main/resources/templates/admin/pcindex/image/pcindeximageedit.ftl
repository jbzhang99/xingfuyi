...
$(function(){
	...
	$("#edit").click(function(){
		...
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.urlResources}/admin/pcindex/image/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">编辑首页的一些图片<span class="s-poar"><a class="a-back" href="${domainUrlUtil.urlResources}/admin/pcindex/image">返回</a></span></h2>
			...
			<dl class="dl-group">
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
						...
						<p class="p12 p-item">
							<label class="lab-item">&nbsp;</label>
							<img alt="图片" src="${domainUrlUtil.imageResources}${pcIndexImage.image}">
						</p>
