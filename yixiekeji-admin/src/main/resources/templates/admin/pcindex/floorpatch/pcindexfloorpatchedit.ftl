...
$(function(){
	...
	$("#back").click(function(){
 		window.location.href="${domainUrlUtil.urlResources}/admin/pcindex/floorpatch";
	});
	$("#edit").click(function(){
		...
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.urlResources}/admin/pcindex/floorpatch/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">编辑首页楼层碎屑<span class="s-poar"><a class="a-back" href="${domainUrlUtil.urlResources}/admin/pcindex/floorpatch">返回</a></span></h2>
