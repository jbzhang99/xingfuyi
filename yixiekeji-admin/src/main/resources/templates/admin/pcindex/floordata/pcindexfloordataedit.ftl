...
$(function(){
	...
	$("#back").click(function(){
 		window.location.href="${domainUrlUtil.urlResources}/admin/pcindex/floordata";
	});
	$("#edit").click(function(){
		...
		if (dataType == null || dataType == "") {
        	...
        	var imageFileNew = $("#imageFile").val();
        	if ((imageFile == null || imageFile == "") && (imageFileNew == null || imageFileNew == "")) {
		...
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.urlResources}/admin/pcindex/floordata/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">编辑楼层数据<span class="s-poar"><a class="a-back" href="${domainUrlUtil.urlResources}/admin/pcindex/floordata">返回</a></span></h2>
			...
			<dl class="dl-group">
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
						...
						<p class="p12 p-item">
							<label class="lab-item">&nbsp;</label>
							<img alt="图片" style="width: 185px;height: 247px;" src="${domainUrlUtil.imageResources}${(pcIndexFloorData.image)!''}">
						</p>
					</div>
					<br/>
					</div>
