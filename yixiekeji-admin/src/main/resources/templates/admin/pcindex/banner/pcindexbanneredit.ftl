...
$(function(){
	...
	$("#back").click(function(){
 		window.location.href="${domainUrlUtil.urlResources}/admin/pcindex/banner";
	});
	$("#edit").click(function(){

		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.urlResources}/admin/pcindex/banner/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">编辑首页轮播图<span class="s-poar"><a class="a-back" href="${domainUrlUtil.urlResources}/admin/pcindex/banner">返回</a></span></h2>
					...
					<div class="fluidbox">
						...
						<p class="p12 p-item">
							...
							<img alt="图片" style="width: 770;height: 445px;"
											src="${domainUrlUtil.imageResources}${pcIndexBanner.image}">
						</p>
