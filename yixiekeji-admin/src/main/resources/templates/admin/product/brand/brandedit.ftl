...
<script language="javascript">
    $(function () {
        ...
        var options = {
            url: '${domainUrlUtil.urlResources}${currentBaseUrl}update',
            type: 'post',
...
<div class="wrapper">
    <div class="formbox-a">
        <h2 class="h2-title">品牌编辑
            <span class="s-poar">
                <a class="a-back" href="${domainUrlUtil.urlResources}${currentBaseUrl}">返回</a>
            </span>
        </h2>
                ...
                <dd class="dd-group">
                    ...
                    <div class="fluidbox">
                        <p class="p6 p-item">
                            ...
                            <a href="${domainUrlUtil.imageResources}/${(brand.image)!''}" class='colorbox'>点击查看</a>
                        </p>
                        <p class="p6 p-item">
