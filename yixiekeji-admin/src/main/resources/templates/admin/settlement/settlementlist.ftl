	...
	$(function() {
		...
		$("#btn-detail").click(function(){
			...
			if(!selectedCode){
	 		...
	 		window.location.href="${(domainUrlUtil.urlResources)!}/admin/settlement/detail?id="+selectedCode.id;
		});	
	...
	<table id="dataGrid" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th field="settleCycle" width="100" align="center">结算周期</th>
				...
				<th field="moneyIntegral" width="100" align="center">积分转换总额</th>
				<th field="integral" width="100" align="center">积分总额</th>
