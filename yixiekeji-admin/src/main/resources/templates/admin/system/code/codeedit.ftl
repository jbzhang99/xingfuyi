...
$(function(){
	$("#back").click(function(){
	 		window.location.href="${domainUrlUtil.urlResources}/admin/system/code";
		});
	$("#edit").click(function(){
		if($("#editForm").form('validate')){
	 		$("#editForm").attr("action", "${domainUrlUtil.urlResources}/admin/system/code/update")
  				 .attr("method", "POST")
  				 .submit();
		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">字典修改<span class="s-poar"><a class="a-back" href="${domainUrlUtil.urlResources}/admin/system/code">返回</a></span></h2>
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
						<p class="p6 p-item">
							...
							<input type="text" id="codeText" name="codeText" value="${(code.codeText)!''}" 
								class="txt w200 easyui-validatebox" missingMessage="CODE名称必须填写，输入2到20个字符" 
