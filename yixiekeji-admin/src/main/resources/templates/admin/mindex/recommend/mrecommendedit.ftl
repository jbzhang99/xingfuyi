...
$(function(){
	$("#back").click(function(){
 		window.location.href="${domainUrlUtil.urlResources}/admin/mindex/recommend";
	});
	$("#edit").click(function(){

		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.urlResources}/admin/mindex/recommend/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">编辑推荐商品<span class="s-poar"><a class="a-back" href="${domainUrlUtil.urlResources}/admin/mindex/recommend">返回</a></span></h2>
