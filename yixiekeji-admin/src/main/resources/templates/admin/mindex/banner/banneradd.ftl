...
$(function(){
	...
	$("#add").click(function(){
		...
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.urlResources}/admin/mindex/banner/create")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">添加轮播图<span class="s-poar"><a class="a-back" href="${domainUrlUtil.urlResources}/admin/mindex/banner">返回</a></span></h2>
