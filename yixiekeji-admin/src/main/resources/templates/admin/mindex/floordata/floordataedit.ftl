...
$(function(){
	...
	$("#back").click(function(){
 		window.location.href="${domainUrlUtil.urlResources}/admin/mindex/floordata";
	});
	$("#edit").click(function(){
		...
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.urlResources}/admin/mindex/floordata/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">编辑楼层数据<span class="s-poar"><a class="a-back" href="${domainUrlUtil.urlResources}/admin/mindex/floordata">返回</a></span></h2>
			...
			<dl class="dl-group">
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
						...
						<p class="p12 p-item">
							<label class="lab-item">&nbsp;</label>
							<img alt="图片" style="width: 144px;height: 144px;" src="${domainUrlUtil.imageResources}${(mIndexFloorData.image)!''}">
						</p>
					</div>
					<br/>
					<br/>
