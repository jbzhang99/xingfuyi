...
$(function(){
	...
	$("#edit").click(function(){
		...
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.urlResources}/admin/seller/audit/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});

	$('input[type=radio][name=invoiceFlag]').each(function(){
	       if($(this).val() == 0){
     ...
     $('input[type=radio][name=invoiceFlag]').change(function () {
             $("#radio1").val(0);
             $("#radio2").val(1);
     });
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">修改商家申请<span class="s-poar"><a class="a-back" href="${domainUrlUtil.urlResources}/admin/seller/audit">返回</a></span></h2>
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<a href="${domainUrlUtil.imageResources}/${(sellerApply.bussinessLicenseImage)!''}" target="_blank">点击查看</a>
						</p>
					</div>
					<div class="fluidbox">
						<p class="p12 p-item">
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<a href="${domainUrlUtil.imageResources}/${(sellerApply.personCardUp)!''}" target="_blank">点击查看</a>
						</p>
					</div>
					<br/>
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<a href="${domainUrlUtil.imageResources}/${(sellerApply.personCardDown)!''}" target="_blank">点击查看</a>
						</p>
					</div>
					<div class="fluidbox">
						<p class="p12 p-item">
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
                        <p class="p12 p-item">
                            ...
                            <input  type="radio" name="invoiceFlag" id="radio1" value="${(sellerApply.invoiceFlag)!''}" data-options="required:true"> 是
                            <input  type="radio" name="invoiceFlag" id="radio2" value="${(sellerApply.invoiceFlag)!''}" data-options="required:true"> 否
                        </p>
                     </div>
					<br/>
				</dd>
