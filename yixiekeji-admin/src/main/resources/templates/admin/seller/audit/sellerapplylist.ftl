...
<#assign currentBaseUrl="${domainUrlUtil.urlResources}/admin/seller/audit"/>
<script language="javascript">
	...
	$(function() {
		...
		$("#btn-gridAdd").click(function(){
	 		window.location.href="${(domainUrlUtil.urlResources)!}/admin/seller/audit/add";
		});
		...
		$("#btn-gridEdit").click(function(){
			...
			if (selected.state != 1 && selected.state != 4) {
	 		...
	 		window.location.href="${(domainUrlUtil.urlResources)!}/admin/seller/audit/edit?sellerApplyId="+selected.id;
		});
	});
