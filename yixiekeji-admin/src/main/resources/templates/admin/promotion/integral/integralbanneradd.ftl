...
$(function(){
	...
	$("#add").click(function(){
		...
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.urlResources}/admin/actintegralbanner/banner/create")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">添加积分商城首页轮播图<span class="s-poar"><a class="a-back" href="${domainUrlUtil.urlResources}/admin/actintegralbanner/banner">返回</a></span></h2>
				...
				<dd class="dd-group">
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<input class="easyui-validatebox txt w280" type="text" id="title" name="title" value="${(actIntegralBanner.title)!''}" data-options="required:true,validType:'length[1,50]'" >
						</p>
					</div>
					<br/>
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<input class="easyui-validatebox txt w280" type="text" id="linkUrl" name="linkUrl" value="${(actIntegralBanner.linkUrl)!''}" data-options="required:true,validType:'length[5,100]'" >
						</p>
						<p class="p12 p-item">
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<@cont.radio id="type" name="pcMobile" value="${(actIntegralBanner.pcMobile)!''}" codeDiv="PC_MOBILE"/>
						</p>
					</div>
					<br/>
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<input class="easyui-numberbox w280" type="text" id="orderNo" name="orderNo" value="${(actIntegralBanner.orderNo)!''}" data-options="required:true,min:1,max:99" >
						</p>
						<p class="p12 p-item">
							<label class="lab-item">&nbsp;</label>
							<label>
					...
					<div class="fluidbox">
						...
						<input type="text" id="startTime" name="startTime"
								...
								value="${(actIntegralBanner.startTime?string('yyyy-MM-dd HH:mm:ss'))!''}" readonly="readonly">
						~
						<input type="text" id="endTime" name="endTime"
								...
								value="${(actIntegralBanner.endTime?string('yyyy-MM-dd HH:mm:ss'))!''}" readonly="readonly">
					</div>
					<br/>
					<div class="fluidbox">
						<p class="p12 p-item">
						...
						<p class="p12 p-item">
							...
							<label>
								<font style="color: #808080">
								PC积分商城图片最佳像素（或保持该比例）：宽740，高240；移动端积分商城图片最佳像素（或保持该比例）：宽720，高350；
								</font>
							</label>
						</p>
					</div>
