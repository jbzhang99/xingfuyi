...
$(function(){
	...
	$("#back").click(function(){
 		window.location.href="${domainUrlUtil.urlResources}/admin/promotion/single";
	});
	...
	$("#auditPass").click(function(){
        $.messager.confirm('提示', '确定审核通过该活动吗？', function(r){
            if (r){
                ...
                $.ajax({
                    type:"POST",
                    url: "${domainUrlUtil.urlResources}/admin/promotion/single/doaudit",
                    dataType: "json",
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">审核单品立减<span class="s-poar"><a class="a-back" href="${domainUrlUtil.urlResources}/admin/promotion/single">返回</a></span></h2>
