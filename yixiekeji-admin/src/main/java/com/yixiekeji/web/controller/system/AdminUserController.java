 ...
 */
@Controller
@RequestMapping(value = "admin/system/adminuser", produces = "application/json;charset=UTF-8")
@Scope("prototype")
public class AdminUserController extends BaseController {
    ...
    public @ResponseBody HttpJsonResult<List<SystemAdmin>> list(HttpServletRequest request,
        ...
        ServiceResult<List<SystemAdmin>> serviceResult = systemAdminService.page(feignUtil);
    ...
    public String add(HttpServletRequest request, Map<String, Object> dataMap) {
        ...
        dataMap.put("roles", rolesService.page(feignUtil).getResult());
