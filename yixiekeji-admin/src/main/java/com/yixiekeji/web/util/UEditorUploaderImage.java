...
public class UEditorUploaderImage {
    ...
    public void upload(String uploadPath) throws Exception {
        ...
        try {
            ...
            System.out.println("-----fii:" + fii.hasNext());
            ...
            while (fii.hasNext()) {
                ...
                if (!fis.isFormField()) {
                    ...
                    String result = uploadUtil.uEditorUploaderImage(file, request, uploadPath);
                    System.out.println("result---------" + result);
                    if (result != null && !"null".equals(result)) {
                        if (result.contains("/")) {
                            this.url = uploadPath + result;
                        } else {
                            this.state = result;
                        }
                    } else {
