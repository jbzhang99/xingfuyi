 ...
 *   <tr><td>productTypeAttrId</td><td>{@link java.lang.Integer}</td><td>product_type_attr_id</td><td>int</td><td>属性ID，可以根据属性ID来进行检索</td></tr>
 *   <tr><td>name</td><td>{@link java.lang.String}</td><td>name</td><td>varchar</td><td>属性名称</td></tr>
 *   <tr><td>value</td><td>{@link java.lang.String}</td><td>value</td><td>varchar</td><td>属性值</td></tr>
 *   <tr><td>state</td><td>{@link java.lang.Integer}</td><td>state</td><td>tinyint</td><td>1、检索属性；2、自定义属性；3、商品自定义属性（product_tyep_attr_id=0）</td></tr>
 * </table>
 *
 */
