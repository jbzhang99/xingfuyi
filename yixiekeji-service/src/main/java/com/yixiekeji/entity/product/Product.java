...
public class Product implements Serializable {
    ...
    private String               noTransInfo;                                //商品不發貨區域
    private Integer              transportId;                                //运费模板id

    private java.math.BigDecimal saleScale1;                                 //一级分销比例
    private java.math.BigDecimal saleScale2;                                 //二级分销比例
    ...
    private Integer              full                 = 0;                   //订单满减
    private Integer              coupon               = 0;                   //优惠券
    private Integer              single               = 0;                   //单品立减
    private Integer              special              = 0;                   //闪购
    ...
    /**
     * @return the noTransInfo
     */
    public String getNoTransInfo() {
        return noTransInfo;
    }

    /**
     * @param noTransInfo the noTransInfo to set
     */
    public void setNoTransInfo(String noTransInfo) {
        this.noTransInfo = noTransInfo;
    }
