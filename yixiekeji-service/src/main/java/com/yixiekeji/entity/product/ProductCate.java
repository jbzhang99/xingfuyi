 ...
 *   <tr><td>productTypeId</td><td>{@link java.lang.Integer}</td><td>product_type_id</td><td>int</td><td>类型ID</td></tr>
 *   <tr><td>pid</td><td>{@link java.lang.Integer}</td><td>pid</td><td>int</td><td>父类ID</td></tr>
 *   <tr><td>name</td><td>{@link java.lang.String}</td><td>name</td><td>varchar</td><td>分类名称</td></tr>
 *   <tr><td>path</td><td>{@link java.lang.String}</td><td>path</td><td>varchar</td><td>上级分类路径</td></tr>
 *   <tr><td>scaling</td><td>{@link java.math.BigDecimal}</td><td>scaling</td><td>decimal</td><td>分佣比例(商家给平台的分佣比例，填写0到1的数字)</td></tr>
 ...
 *   <tr><td>status</td><td>{@link java.lang.Integer}</td><td>status</td><td>tinyint</td><td>0、默认；1、提交审核；2、审核通过；3、审核失败；4、停用</td></tr>
 * </table>
 */
