 ...
 *   <tr><td>orderPsn</td><td>{@link java.lang.String}</td><td>order_psn</td><td>varchar</td><td>父订单编号</td></tr>
 *   <tr><td>isParent</td><td>{@link java.lang.Integer}</td><td>is_parent</td><td>tinyint</td><td>是否总订单：0-否；1-是，总订单在买家支付前使用，子订单在平台和商家端使用</td></tr>
 *   <tr><td>isShow</td><td>{@link java.lang.Integer}</td><td>is_show</td><td>tinyint</td><td>是否显示：0-否；1-是，总订单在支付前为1，支付后为0，子订单反之，用于买家端显示</td></tr>
 ...
 *   <tr><td>taxNum</td><td>{@link java.lang.String}</td><td>tax_num</td><td>varchar</td><td>纳税人识别号</td></tr>
 * </table>
 *
 */
public class Orders implements Serializable {
    ...
    /** 订单表  order_type  订单类型：1、普通订单，2、限时抢购订单，3、团购订单，4、竞价定金订单，5、竞价尾款订单，6、积分换购订单 */
    ...
    public final static String   PAYMENT_CODE_APPWXPAY   = "APPWXPAY";
    /** 付款name：APPWXPAY，app微信 */
    public final static String   PAYMENT_NAME_APPWXPAY   = "app微信";
    /** 付款code：H5WXPAY，H5微信 */
    public final static String   PAYMENT_CODE_XCXWXPAY   = "XCXWXPAY";
    /** 付款name：H5WXPAY，H5微信 */
    public final static String   PAYMENT_NAME_XCXWXPAY   = "XCX微信";
    ...
    private java.lang.String     orderPsn;
    ...
    private Boolean              isShowBackAndExchange;                        //是否显示收货和换货按钮
     ...
     * 获取父订单编号
     */
    public java.lang.String getOrderPsn() {
     ...
     * 设置父订单编号
     */
    public void setOrderPsn(java.lang.String orderPsn) {
        this.orderPsn = orderPsn;
    }

    /**
     * 获取是否总订单：0-否；1-是，总订单在买家支付前使用，子订单在平台和商家端使用
     */
    ...
    /**
     * 设置是否总订单：0-否；1-是，总订单在买家支付前使用，子订单在平台和商家端使用
     */
    ...
    /**
     * 获取是否显示：0-否；1-是，总订单在支付前为1，支付后为0，子订单反之，用于买家端显示
     */
    ...
    /**
     * 设置是否显示：0-否；1-是，总订单在支付前为1，支付后为0，子订单反之，用于买家端显示
     */
    ...
    /**
     * 订单类型：1、普通订单，2、限时抢购订单，3、团购订单，4、竞价定金订单，5、竞价尾款订单
     */
    ...
    public Boolean getIsShowBackAndExchange() {
        return isShowBackAndExchange;
    }

    public void setIsShowBackAndExchange(Boolean isShowBackAndExchange) {
