package com.yixiekeji.entity.coupon;
...
public class Coupon implements Serializable {
    ...
    private Integer              memberReceivedNum;                      // 会员已领取数量（用于优惠券列表页）
    ...
    public Integer getMemberReceivedNum() {
        return memberReceivedNum;
    }

    public void setMemberReceivedNum(Integer memberReceivedNum) {
        this.memberReceivedNum = memberReceivedNum;
    }
