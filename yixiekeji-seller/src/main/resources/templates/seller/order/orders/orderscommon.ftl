...
<#assign currentBaseUrl="${domainUrlUtil.urlResources}/seller/order/orders"/>
...
$(function (){
	...
	$("#btn-details").click(function (){
		...
		location.href="${domainUrlUtil.urlResources}/seller/order/orders/details?id="+selected.id;
	});
});
...
function onExpandRow(index,row){
    ...
    ddv.datagrid({
       ...
       singleSelect:true,
       method:'get',
       url:'${domainUrlUtil.urlResources}/seller/order/ordersProduct/getOrdersProduct?orderId='+row.id,
		loadMsg : '数据加载中...',
		height : 'auto',
		columns : [[{
			field : 'productName',
