...
$(function(){
	...
	$("button[type='button'].back").click(function(){
 		window.location.href="${domainUrlUtil.urlResources}/seller/pcindex/recommenddata";
	});
		...
		<div class="page-content">
			...
			<div class="page-breadcrumbs">
				<ul class="breadcrumb">
					...
					<li>
					<a
						href="${domainUrlUtil.urlResources}/seller/pcindex/recommenddata">推荐类型数据</a>
					</li>
					<li class="active">编辑推荐类型数据</li>
				</ul>
			...
			<div id="bodyejavashop" style="overflow-y: auto; overflow-x: hidden;">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					...
					<form method="post" id="addform" class="form-horizontal"
						action="${domainUrlUtil.urlResources}/seller/pcindex/recommenddata/update"
						...
						<div class="form-group dataPrdDiv" <#if pcSellerRecommendData?? && pcSellerRecommendData.dataType?? && pcSellerRecommendData.dataType != 1>style="display:none;"</#if>>
							...
							<div class="col-lg-8">	
								<input id="proname" name="proname" 
										<#if pcSellerRecommendData?? && pcSellerRecommendData.dataType?? && pcSellerRecommendData.dataType != 2>
										required
										</#if>
										class="form-control"
										readonly="readonly"
						...
						<div class="form-group dataLinkDiv" <#if pcSellerRecommendData?? && pcSellerRecommendData.dataType?? && pcSellerRecommendData.dataType != 2>style="display:none;"</#if>>
						...
						<div class="form-group dataLinkDiv" <#if pcSellerRecommendData?? && pcSellerRecommendData.dataType?? && pcSellerRecommendData.dataType != 2>style="display:none;"</#if>>
							...
							<div class="col-lg-4">
								<a href="${domainUrlUtil.imageResources}${(pcSellerRecommendData.image)!''}" class='boxer'>查看图片</a>
							</div>
						</div>
