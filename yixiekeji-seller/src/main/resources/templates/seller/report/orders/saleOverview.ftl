            ...
            <div class="page-body">
              <div id="bodyejavashop" class="easyui-layout ejava-easyui-layout" data-options="fit:true,split:false" style="height:300px; " >
                <div class="whtitdiv" data-options="region:'north'" style="padding-top: 10px;overflow-x:hidden;overflow-y:auto;">
                    ...
                    <form class="from-ff"
						action="${domainUrlUtil.urlResources}/seller/report/orders/saleOverview"
                      ...
                      <div class="row">
                          <div class="col-lg-12 col-sm-12 col-xs-12">
                              <div class="row row-mgbot">
                                  ...
                                  <div class="col-lg-4 col-sm-6 col-xs-12 month" style="display: none">
					...
					<div data-options="region:'south'" style="height:130px;">
						<dl class="dl-group" style="margin: 10px;">
							...
							<dd class="dd-group">
								<div class="fluidbox">
									<label class="lab-item help"> 订单销量统计展示网店在一段时间内的订单数和销售总额度及客单价,客单价 = 订单总金额/订单总数；
