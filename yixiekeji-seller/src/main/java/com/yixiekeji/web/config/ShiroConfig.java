...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(ShiroDbRealm myShiroRealm) {
        ...
        filterChainDefinitionMap.put("/seller/login.html", "anon");
        filterChainDefinitionMap.put("/seller/doLogin", "anon");
        filterChainDefinitionMap.put("/seller/index.html", "anon");
        filterChainDefinitionMap.put("/seller/exit", "logout");
        filterChainDefinitionMap.put("/seller/unauth.htmlt", "anon");

        filterChainDefinitionMap.put("/seller/sellerPurchase", "anon");
        filterChainDefinitionMap.put("/seller/orderOverview", "anon");
        filterChainDefinitionMap.put("/seller/saleOverview", "anon");
        filterChainDefinitionMap.put("/seller/systemNotice/getUnreadNotice", "anon");
        filterChainDefinitionMap.put("/seller/changethtme", "anon");
        filterChainDefinitionMap.put("/seller/system/error404", "anon");
        filterChainDefinitionMap.put("/seller/system/error500", "anon");
        filterChainDefinitionMap.put("/seller/system/verifyCode", "anon");
        ...
        //默认的登陆访问url
        shiroFilterFactoryBean.setLoginUrl("/seller/login.html");
        //登陆成功后跳转的url
        shiroFilterFactoryBean.setSuccessUrl("/seller/index.html");
        // 未授权界面;
        shiroFilterFactoryBean.setUnauthorizedUrl("/seller/unauth.html");
