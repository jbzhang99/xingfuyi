...
public class WebFrontSession {
    ...
    public static void putMemberSession(HttpServletRequest request, Member member) {
        ...
        System.out.println("put:" + session.getId());
        ...
        if (member != null) {
            ...
            // 是否更新库sessionID
            if (member.getLoginSource() == ConstantsEJS.YES_NO_1) {
                Member memberNew = new Member();
                memberNew.setId(member.getId());
                memberNew.setSessionId(sessionId);
                webFrontSession.memberService.updateMember(memberNew);
            }
    ...
    public static Member getMemberBySessionId(String sessionId) {
    	ServiceResult<Member> result = webFrontSession.memberService
    ...
    public static Member getLoginedUser(HttpServletRequest request, HttpServletResponse response) {
