...
public class AppMemberIntegralController extends BaseController {
    ...
    @RequestMapping(value = "/app-integral.html", method = { RequestMethod.GET })
     ...
     * @return
     */
    @RequestMapping(value = "/app-integralJson.html", method = RequestMethod.GET)
