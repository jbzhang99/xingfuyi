...
public class PaginationUtil implements Serializable {
    ...
    public String getPageHtml() {
        ...
        if (num != 1) {
            stb.append("<a href='" + (url + 1) + "'><span class='page-first'>首页</span></a><a href='"
                       + (url + prev) + "'><span class='page_next'>上一页</span></a>");
        } else {
        ...
        if (beginPage <= pageCount) {
            ...
            for (int j = 0; (i <= pageCount) && (j < 6); j++) {
                if (num != i) {
                    stb.append(
                        "<a href='" + (url + i) + "'><span class='page-wrap'>" + i + "</span></a>");
                } else {
        ...
        if (num != 0 && pageCount != 0 && num != pageCount) {
            stb.append(
                "<a href='" + (url + next) + "'><span class='page_next'>下一页</span></a><a href='"
                       + (url + last) + "'><span class='page_next'>尾页</span></a>");
        } else {
