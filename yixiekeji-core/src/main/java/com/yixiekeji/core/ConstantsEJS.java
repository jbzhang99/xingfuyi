...
public class ConstantsEJS {
    ...
    public final static String NAMESPACE_MOBILEMALL_WEB_MEMBER         = "yixiekeji:b2b2c:web:member";
    ...
    /**短信最大有效时间（分钟）*/
    public static final int    SMS_MAX_WAIT_TIME                       = 60 * 60 * 5;

    /** cookie默认过期时间24小时 */
    public static final int    COOKIE_DEFAULT_TIME_OUT                 = 24 * 60 * 60;
    /** session默认过期时间60分钟 */
    public static final long   SESSION_DEFAULT_TIME_OUT                = 60 * 60;
}
