...
import com.yixiekeji.core.PaginationFrontUtil;
...
public class ProductListController extends BaseController {
    ...
    public String productList(@PathVariable String visitPath, HttpServletRequest request,
        ...
        //分页对象
        PaginationFrontUtil pm = new PaginationFrontUtil(page == 0 ? 1 : page,
            ConstantsEJS.DEFAULT_PAGE_SIZE, Integer.valueOf(stack.get("productSize").toString()));
        stack.put("page", pm);
