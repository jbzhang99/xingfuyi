		...
		<div class="main-fram">
			<div class="jifen_top">
				...
				<div class="fr">
					...
					<a href="${(domainUrlUtil.urlResources)!}/jifen.html" target="_blank" class="jf-btn">兑换商品</a>
				</div>
			</div>
			<div class="content_tit">
				...
				<div class="fr coupon_fr">
					<a href="${(domainUrlUtil.urlResources)!}/news/2.html" target="_blank" class="colblue">积分规则说明</a>
				</div>
			</div>
