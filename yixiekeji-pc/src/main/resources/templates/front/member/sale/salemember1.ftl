...
<link rel="stylesheet" type="text/css" href="${(domainUrlUtil.staticResources)!}/css/usersale.css"/>
		...
		<div class='container'>
			<div class='breadcrumb'>
				...
				<span>
					&nbsp;>&nbsp;
					<a href='javascript:void(0)'>推广用户</a>
				</span>
			</div>
		</div>
		<div class='container'>
			...
			<div class='wrapper_main myorder wrapper_main-wd'>
				...
				<div class="reminder-con reminder-Detailed">
					...
					<div class="derailedCon">
						<form action="${(domainUrlUtil.urlResources)!}/member/sale-member1.html" class="mybalance-search" method="get">
							<div class="searchItm">
	...
	<script type="text/javascript">
		$(function(){
			//控制左侧菜单选中
			$("#saleSaleMember").addClass("currnet_page");
		});
	</script>
